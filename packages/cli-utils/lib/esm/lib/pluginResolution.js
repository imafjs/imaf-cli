...
export const isPlugin = (id) => pluginRE.test(id);
export const isOfficialPlugin = (id) => isPlugin(id) && officialRE.test(id);
export const toShortPluginId = (id) => id.replace(pluginRE, '');
export const resolvePluginId = (id) => {
    // already full id
...
export const matchesPluginId = (input, full) => {
