...
const loadModule = function (request, context, force = false) {
    ...
    try {
        ...
        const resolvedPath = (0, exports.resolveModule)(request, context);
        if (resolvedPath) {
            if (force) {
...
const clearModule = function (request, context) {
    const resolvedPath = (0, exports.resolveModule)(request, context);
    if (resolvedPath) {
        clearRequireCache(resolvedPath);
    }
